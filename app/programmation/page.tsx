...
export const metadata: Metadata = {
  ...
  description: "Découvrez tous les artistes et DJs à l'affiche de la 2ème édition de The Green Fest à Vertou. Une programmation électro, jazz et fusion au cœur du parc de la Sèvre.",
  openGraph: {
    title: "Programmation | The Green Fest 2026",
